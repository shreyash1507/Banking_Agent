...
# Insert into Sidebar before WAVE 1 USE CASES
content = content.replace('<!-- WAVE 1 USE CASES -->', nav_addition + '\n        <!-- WAVE 1 USE CASES -->')
...
"""
content = content.replace("<!-- ── APPROVAL MODAL ── -->", panes_addition + "\n  <!-- ── APPROVAL MODAL ── -->")
...
"""
content = content.replace("<!-- ══════════════════════ SCRIPTS ══════════════════════ -->", js_addition + "\n  <!-- ══════════════════════ SCRIPTS ══════════════════════ -->")
